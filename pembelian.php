        ...
        switch ($_POST['action']) {
            case 'create':
                try {
                    ...
                    $pembelian->supplier_id = sanitizeInput($_POST['supplier_id']);
                    ...
                    foreach ($items as $item) {
                        ...
                        $detail_query = "INSERT INTO detail_pembelian (pembelian_id, menu_id, jumlah, harga_satuan, subtotal) 
                                         VALUES (:pembelian_id, :menu_id, :jumlah, :harga_satuan, :subtotal)";
            ...
            case 'complete':
                ...
                try {
                    ...
                    while ($row = $detail_stmt->fetch(PDO::FETCH_ASSOC)) {
                        $menu->updateStok($row['menu_id'], $row['jumlah']);
                    }
                        ...
                        <div class="form-group">
                            ...
                            <div id="itemsContainer">
                                <div class="item-row" style="display: grid; grid-template-columns: 2fr 1fr 1fr 1fr 1fr; gap: 10px; margin-bottom: 10px; padding: 10px; border: 1px solid #ddd; border-radius: 5px;">
                                    <select class="menu-select" onchange="loadmenuInfo(this)">
